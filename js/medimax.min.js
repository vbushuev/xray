...
window.globalAjaxInjection={matcher:/^\/cart\/.*$/i,cartbefore:function(){$(".xray-header-basket__count").html('<img src="/css/loader.gif" style="height:24px;margin-left:24px;"/>')},cartget:function(a){a=a.cart.itemsAmount+"\u0448\u0442. "+a.cart.amountGross;$(".xray-header-basket__count").html(a)}};
...
queryParameters.status_id:"3"}),$(".cart-actions__checkout-link").click());$.getJSON("/cart/get");$(document).ajaxSend(function(a,b,c){globalAjaxInjection.matcher.test(c.url)&&globalAjaxInjection.cartbefore()});$(document).ajaxSuccess(function(a,b,c,d){console.debug(a,b,c,d);globalAjaxInjection.matcher.test(c.url)&&globalAjaxInjection.cartget(d)})});

...
<!-- <div id="garan24-toper">
    ...
    <div id="garan24-toper-content">
        ...
        <ul class="garan24-toper-menu garan24-toper-menu-left"> -->
            ...
            <li id="garan-helper">Выберите интересующие Вас товары и добавьте их в корзину.</li>
        </ul>
        <ul class="garan24-toper-menu garan24-toper-menu-right"> -->
            ...
            -->
            <!-- <li><div id="garan-currency"></div></li>
            <li>
                <div class="garan-contact">
                    &nbsp;&nbsp;
                    <a href="tel:88007075103"><i class="fa fa-phone"></i> 8 800 707 5103</a>&nbsp;&nbsp;
                    <a href="mailto:contact@gauzymall.com"><i class="fa fa-envelope-o"></i> contact@gauzymall.com</a>
                </div>
            </li>

            <li style="display:none;">
                <a id="garan-cart" class="garan24-cart-x" title="Перейти к редактированию корзины">
            ...
            <li style="display:none;"><a class="garan-checkout garan24-button garan24-button-primary garan24-button-disabled" href="#"><i class="fa fa-shopping-bag"></i> Оформить заказ</a></li>
        </ul>
    </div>
</div> -->
<!--
    ...
    <nav class="navbar navbar-default navbar-fixed-top gauzymall-fixed-navbar">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/"><strong>Gauzymall</strong></a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a class="e-mail" href="mailto:orders@gauzymall.com" data-toggle="tooltip" data-placement="bottom" title="Напишите нам!"><span aria-hidden="true" class="elegant-icon icon_mail_alt"></span> <span class="visible-xs-inline">Обратная связь</span></a></li>
                </ul>
            </div><!--/.nav-collapse -->
        </div>
    </nav>
...
<div class="bs-overlay bootstrap-iso" id="shipping-section">
    <div class="container bs-popup-window-wrapper">
        <div class="bs-popup-window">
            ...
            <h3>Доставка</h3>
            <p>После того, как мы получим все заказанные Вами товары, мы объединим их в одну посылку и отправим их по указанному Вами адресу в Россию. Доставка заказов по России осуществляется компанией Боксберри.</p>
            ...
            <p>Получить информацию о текущем статусе доставки заказа Вы в любой момент сможете в личном кабинете на сайте сервиса <a href="http://www.gauzymall.com/">www.gauzymall.com</a>. Как правило, срок доставки заказа не превышает 20 дней. Стоимость доставки рассчитывается автоматически при оформлении заказа и будет включена в его общую стоимость.</p>
            <p><span class="bs-popup-alert">ВНИМАНИЕ</span> Предоплата за оформленный в нашем сервисе заказ составляет всего 1 рубль. Всю оставшуюся часть суммы Вы оплатите, когда заказ будет доставлен в Россию, в ближайший к Вам региональный центр службы доставки. Платеж будет списан автоматически, все, что нужно сделать Вам – это обеспечить наличие на карте достаточной для оплаты заказа суммы средств.</p>
        </div>
    </div>
</div>

<div class="bs-overlay bootstrap-iso" id="payment-section">
    <div class="container bs-popup-window-wrapper">
        <div class="bs-popup-window">
            <div class="bs-popup-close">
                <i aria-hidden="true" class="elegant-icon icon_close" title="Закрыть"></i>
            ...
            <p>Оплата картой производится с соблюдением всех требований безопасности международных платежных систем при содействии нашего партнера – компании PayNetEasy, имеющей большой опыт в работе с банковскими картами и обеспечивающей безопасное проведение операций с использованием карт.</p>
        </div>
    </div>
</div>
...
<div class="bs-overlay bootstrap-iso" id="how-to-buy-section">
    <div class="container bs-popup-window-wrapper">
        <div class="bs-popup-window">
            ...
            <h3>Как купить</h3>
            <p>Просматривайте и выбирайте товары так же, как и на сайте любого интернет-магазина. Найдя понравившийся Вам товар, нажмите кнопку <strong>«ADD TO BAG»</strong>. Выбранный товар добавится в корзину в правом верхнем углу. Не забудьте указать размеры понравившейся вещи, иначе она не будет добавлена в корзину. На этом этапе цены на товары в корзине показываются в английских фунтах.</p>
            <p>После того, как выбор товаров будет завершен, нажмите на значок корзины в правом верхнем углу, либо на кнопку <strong>«CHECKOUT»</strong> в открывшейся корзине. На экран будет выведен список выбранных Вами товаров, где все цены пересчитаны в рубли по нашему льготному курсу. Это окончательная стоимость выбранных Вами товаров, которая будет списана с Вашей банковской карты после доставки заказа.</p>
            <p>Для оформления доставки нажмите кнопку <strong>«Оформить заказ»</strong>, расположенную в нижней части страницы. Дальше следуйте инструкциям, которые пошагово будут показываться на экране и помогут Вам оформить заказ - введите адрес электронной почты и номер мобильного телефона, выберите способ доставки, укажите адрес, по которому желаете получить заказ. Для того, чтобы ваш заказ мог пересечь границу, укажите свои паспортные данные. Чтобы подтвердить заказ, введите номер своей банковской карты.</p>
            ...
            <p><strong>Успешных покупок!</strong></p>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter39767830 = new Ya.Metrika({
                    id:39767830,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/39767830" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->

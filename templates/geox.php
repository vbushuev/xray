                        ...
                        <div class="bs-overlay bootstrap-iso" id="how-to-buy-section">
                            <div class="container bs-popup-window-wrapper">
                                <div class="bs-popup-window">
                                    ...
                                    <h3>Как купить</h3>
                                    <p>
                                        Заказ оформляется непосредственно на сайте Forever 21 с помощью сервиса Gauzymall, с сохранением всех скидок на продукцию, предлагаемых в оригинальном интернет-магазине.
                                    </p>
                                    <p>
                                        Просматривайте и выбирайте товары так же, как и на сайте любого интернет-магазина. Найдя понравившийся Вам товар, нажмите кнопку <strong style="color: #0C7DCB;">«Add to bag»</strong> <em>(добавить в корзину)</em>.
                                    </p>
                                    <p>
                                        Для оформления доставки перейдите в корзину (нажмите на логотип корзины в правом верхнем углу экрана) и нажмите кнопку <strong style="color: #0C7DCB;">«Оформить заказ»</strong>. Дальше следуйте инструкциям, которые пошагово будут показываться на экране и помогут Вам оформить заказ - введите адрес электронной почты и номер мобильного телефона, выберите способ доставки, укажите адрес, по которому желаете получить заказ. Для того, чтобы ваш заказ мог пересечь границу, укажите свои паспортные данные. Вы можете оплатить заказ сразу или при получении. Требуется банковская карта.
                                    </p>
                            ...
                            <div class="container bs-popup-window-wrapper">
                                <div class="bs-popup-window">
                                    ...
                                    <div class="bs-popup-window-content">
                                        ...
                                        <p class="text-center">Последние новинки молодежной моды!</p>
                                        <p>
Forever 21 – это бренд молодежной моды, широко известный во всем мире. В США сеть магазинов Forever 21 находится на 5-ом месте по объемам продаж и продолжает быстро расширятся.
На сайте Forever 21 предлагаются коллекции, соответствующие самым последним тенденциям моды – то, что появилось на модных показах известных брендов 2 – 4 недели назад. И по вменяемым ценам. А если Вы готовы подождать еще несколько недель, то сможете купить понравившуюся вещь в разделе Sale за совсем небольшую цену. В ассортименте большой выбор жизнерадостной одежды, обуви и аксессуаров для молодых динамичных людей. Есть специальный раздел Plus Size для «больших» модниц.
                                        </p>
...
<div class="bs-overlay bootstrap-iso" id="shipping-section">
    <div class="container bs-popup-window-wrapper">
        <div class="bs-popup-window">
            ...
            <script type="text/javascript" src="/js/boxberry.js"> </script/>
            <script>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="greetings-message">
                            <h1>Привет!</h1>
                            <p>
                                Мы рады видеть Вас в магазине  Forever21 на торговом портале Gauzymall.
                            </p>
                            <p>
                                Forever 21 – это хорошо известный во всем мире бренд молодежной моды.  Forever 21 находится в авангарде нового тренда в производстве одежды – так называемой «Быстрой моды». Предлагаемые на сайте коллекции одежды обновляются очень быстро, стремясь соответствовать моделям, которые появились на модных показах известных брендов 2 – 4 недели назад. При этом цены более чем приемлемы.
                                    В ассортименте большой выбор жизнерадостной одежды, обуви и аксессуаров для молодых динамичных людей. В каждом разделе есть большая секция распродаж. А также специальный раздел Plus Size для «больших» поклонниц моды.
                            ...
                            <p>Просматривайте и выбирайте товары так же, как и на сайте любого интернет-магазина. Найдя понравившийся Вам товар, нажмите кнопку <strong style="color: #0C7DCB;">«Add to Bag»</strong> (добавить в корзину).</p>
                            <p>Для оформления доставки перейдите в корзину и нажмите кнопку «Оформить заказ». Дальше следуйте инструкциям, которые пошагово будут показываться на экране и помогут Вам оформить заказ.</p>
                            <!--

        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                        ...
                        <div class="bs-overlay bootstrap-iso" id="how-to-buy-section">
                            <div class="container bs-popup-window-wrapper">
                                <div class="bs-popup-window">
                                    ...
                                    <h3>Как купить</h3>
                                    <p>
                                        Заказ оформляется непосредственно на сайте GEOX с помощью сервиса Gauzymall, с сохранением всех скидок на продукцию, предлагаемых в оригинальном интернет-магазине.
                                    </p>
                                    <p>
                    ...
                    <li>
                        <a class="main-nav-item shipping">Доставка</a>
                    ...
                    <li>
                        <a class="main-nav-item payment">Оплата</a>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="main-nav-item promo animated-attention" id="promo-action-button">Акция<span class="animated-attention-circle-wrapper"></span><span class="animated-attention-circle">!</span></a>
                            ...
                            <div class="container bs-popup-window-wrapper">
                                <div class="bs-popup-window">
                                    ...
                                    <div class="bs-popup-window-content">
                                        ...
                                        <p class="text-center"><strong>Уникальное предложение от сервиса Gauzymall при покупке товаров в онлайн магазине GEOX:</strong></p>
                                        ...
                                        <p class="text-center">Современные технологии комфорта обуви и одежды!</p>
                                        <p>Визитной карточкой итальянской компании GEOX являются дышащие и водонепроницаемые свойства обуви и одежды, которые обеспечивают моментальное ощущение комфорта в любое время года и в любую погоду. Компания GEOX создаёт и производит верхнюю одежду и обувь для женщин, мужчин и детей и является одним из ведущих мировых брендов в категории Casual. Каждая коллекция GEOX отражает актуальные тенденции сезона. Это одежда и обувь для тех, кто ищет что-то удобное и вместе с тем универсальное, для повседневного использования с утра до вечера, в городе и на природе. Для тех, кто любит легкость и естественность не только в повседневной, но и официальной одежде. Для тех, кто хочет выглядеть стильным и современным без ущерба для комфорта, качества, и прежде всего, хорошего самочувствия.</p>
                    ...
                    <li>
                        <a class="main-nav-item about-us">О нас</a>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="greetings-message">
                            ...
                            <p class="highlighted-text">В ноябре мы проводим акцию:<br />
                                ...
                                - оформление заказа без комиссии!
                            </p>

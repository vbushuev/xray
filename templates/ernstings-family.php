                                ...
                                <div class="row row-for-logo-links">
                                    ...
                                    <div class="col-xs-12 col-sm-4">
                                        <a href="javascript:{jQuery('.bs-overlay').fadeOut();}" class="logo-link close-popup">
                                            <img src="/css/img/ef_logo.png" alt="Ernsting-Family" />
                                            <div class="logo-link-desc">Остаться в Ernsting-Family</div>
                                            <div class="logo-link-overlay"></div>
                                        </a>
                                    </div>
                                    <div class="col-xs-12 col-sm-4">
                            ...
                            <div class="container bs-popup-window-wrapper">
                                <div class="bs-popup-window">
                                    ...
                                    <div class="bs-popup-window-content">
                                        ...
                                        <p class="text-center">Лучшие немецкие товары для всей семьи.</p>
                                        <p>Уже почти 50 лет компания Ernsting’s Family продает одежду на немецком рынке, претворяя в жизнь идею «Модная одежда для всей семьи по доступным ценам».
В ассортименте магазина богатый выбор женской одежды и одежды для детей. Многим покупателям хорошо известны бренды Topomini и Topolino под которыми Ernsting’s Family выпускает товары для детей. Обратите также внимание на раздел женской моды больших размеров. Вы также найдете игрушки, украшения для дома, мужское нижнее белье и многое другое.
Ernsting’s Family очень серьезно относится к качеству и экологической чистоте продаваемых товаров. Например, все продаваемые текстильные изделия соответствуют требованиям стандарта Oeko Tex Standard 100, включающего проверку на содержание вредных веществ по 100 позициям.
Немецкие покупатели по достоинству оценили товары от Ernsting’s Family. Компания продолжает активно развиваться и в настоящий момент сеть Ernsting’s Family включает в себя 1800 магазинов.
Присоединяйтесь!
</p>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        <div class="greetings-message">
                            <h1>Привет!</h1>
                            <p>
                                Мы рады видеть Вас в магазине  Ernsting’s Family на торговом портале Gauzymall.
                            </p>
                            <p>
                                Семейная компания Ernsting’s Family продает одежду на немецком рынке с 1967 года,  претворяя в жизнь идею «Модная одежда для всей семьи по доступным ценам».В ассортименте магазина богатый выбор женской одежды и одежды для детей. Обратите внимание на раздел женской моды больших размеров. Вы также найдете игрушки, украшения для дома, мужское нижнее белье и многое другое.
                            </p>
                            <p>
                                Ernsting’s Family продает товары, выпускаемые под собственными брендами и очень серьезно относится к качеству и экологической чистоте продукции. Например, текстильные изделия соответствуют требованиям стандарта Oeko Tex Standard 100, по которому содержание вредных веществ проверяется по 100 позициям.
                            </p>
                            <p>
                            ...
                            <p>Просматривайте и выбирайте товары так же, как и на сайте любого интернет-магазина. Мы постарались перевести его на русский язык и сделать покупки удобнее.</p>
                            <!--

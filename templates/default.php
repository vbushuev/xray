...
<div class="bs-overlay bootstrap-iso" id="how-to-buy-section">
    <div class="container bs-popup-window-wrapper">
        <div class="bs-popup-window">
            ...
            <h3>Как купить</h3>
            <p>
                Просматривайте и выбирайте товары так же, как и на сайте любого интернет-магазина. Найдя понравившийся Вам товар, нажмите кнопку <img src="/css/img/baby-walz.add2cart.gif" alt="Добавить в корзину" /> (Добавить в корзину по-французски).
            </p>
            <p>
                Далее:
                <ul>
                    <li>
                        чтобы продолжить покупки нажмите <img src="/css/img/baby-walz.continueshopping.gif" alt="Продолжить покупки" />
                    </li>
                    <li>
                        или перейдите к оформлению заказа <img src="/css/img/baby-walz.checkout.gif" alt="Оформить заказ" />.
                    </li>
                </ul>
            </p>

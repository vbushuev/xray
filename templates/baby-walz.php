    ...
    <nav class="navbar navbar-default navbar-fixed-top gauzymall-fixed-navbar" style="display:none;">
        <div class="container">
            <div class="navbar-header">
                ...
                <!--<a class="navbar-brand" href="/"><strong>Gauzy</strong><code>mall</code></a>-->
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a class="main-nav-item e-mail" href="mailto:orders@gauzymall.com" data-toggle="tooltip" data-placement="bottom" title="Напишите нам!"><span aria-hidden="true" class="elegant-icon icon_mail_alt"></span> <span class="visible-xs-inline">Обратная связь</span></a></li>
                </ul>
            </div><!--/.nav-collapse -->
        </div>
    </nav>
...
<div class="bs-overlay bootstrap-iso" id="shipping-section">
    <div class="container bs-popup-window-wrapper">
        <div class="bs-popup-window">
            ...
            <p>Получить информацию о текущем статусе доставки заказа Вы в любой момент можете в личном кабинете на сайте сервиса <a href="http://www.gauzymall.com/">www.gauzymall.com</a>. Как правило, срок доставки заказа не превышает 20 дней. Стоимость доставки рассчитывается автоматически и включается в его общую стоимость заказа.</p>
        </div>
    </div>
</div>
